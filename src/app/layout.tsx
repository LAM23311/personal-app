  ...
  return (
    <html lang="zh-CN">
      <body className="min-h-screen pb-16">
        ...
        >
          <Link href="/" className="flex flex-col items-center justify-center flex-1 h-full transition-colors active:scale-90" style={{ color: '#8A7F73' }}>
          ...
          <Link href="/expense" className="flex flex-col items-center justify-center flex-1 h-full transition-colors active:scale-90" style={{ color: '#8A7F73' }}>
          ...
          <Link href="/journal" className="flex flex-col items-center justify-center flex-1 h-full transition-colors active:scale-90" style={{ color: '#8A7F73' }}>
          ...
          <Link href="/undercover" className="flex flex-col items-center justify-center flex-1 h-full transition-colors active:scale-90" style={{ color: '#8A7F73' }}>
          ...
          <Link href="/cheese" className="flex flex-col items-center justify-center flex-1 h-full transition-colors active:scale-90" style={{ color: '#8A7F73' }}>
            <svg className="w-[22px] h-[22px]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M12 4c-1.5 0-3 .5-4 1.5S6 7.5 6 9v5a6 6 0 0012 0V9c0-1.5-1-3-2-3.5S13.5 4 12 4zM9 11.5a1 1 0 100-2 1 1 0 000 2zM15 11.5a1 1 0 100-2 1 1 0 000 2zM8 6C7.5 4.5 6 3.5 6 3.5M16 6c.5-1.5 2-2.5 2-2.5" /></svg>
